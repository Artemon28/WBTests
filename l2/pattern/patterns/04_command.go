...
/*
Паттерн применяется когда у нас есть повторяющиеся запросы/действия, и мы хотим работать над ними как над объектами.
Это даёт нам возможность хранить, передавать и взаимоизменять внутри других объектов.
Выполнение задач в очереди или параллельно
операция отмены
*/

/*
Плюсы:
1) Убираетзависимость между объектами ивызывающими их операциями
2) Логирование опираций
3) Можно сделать сложную команду из нескольких простых
*/
